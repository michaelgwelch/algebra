...
\begin{enumerate}[A.]
   ...
   \begin{figure}[ht]
      \scalebox{.75}{\includegraphics{img/symmetric_diff.png}}
   ...
   \begin{figure}[ht]
      \scalebox{.25}{\includegraphics{img/interlock_circles.png}}
   \end{figure}
   ...
   \item \textsc{A Checkerboard Game}
      \begin{figure}[ht]
      \scalebox{0.15}{\includegraphics{img/four_square_checker.png}}
   \end{figure}
